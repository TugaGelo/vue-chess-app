...
const formTitle = computed(() => {
  ...
  if (formMode.value === 'login') return 'Welcome Back';
  ...
  <div class="auth-container">
    <div class="auth-box">
      ...
      <form @submit.prevent="handleAuth">
        <input v-if="formMode === 'register'" v-model="username" type="text" placeholder="Username" required />
...
input { width: 90%; padding: 12px; margin-bottom: 15px; border: 1px solid #ccc; border-radius: 4px; font-size: 16px; }
